...
* If answering question: 1 sentence per user question + Markdown links to source (if applicable)
* If asking design decision or PROPOSAL choice, then present PROPOSAL REPORT:
