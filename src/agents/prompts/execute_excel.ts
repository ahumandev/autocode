...
3. Use the \`task\` tool to call \`query-excel\` only for large workbook scans, summaries, or lookups before acting.
...
- Task \`query-excel\` subagent for large summaries, scans, lookups, or locating ranges before acting.
