...
3. Use the \`subagent\` tool to call \`query-excel\` only for large workbook scans, summaries, or lookups before acting.
...
- Call \`query-excel\` subagent via \`subagent\` for large summaries, scans, lookups, or locating ranges before acting.
