...
Check if \`AGENTS.md\` exists, if not abort Workflow with instruction to user to first run \`/docs\` command that will task \`execute-document\` agent to document project.
