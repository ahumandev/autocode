...
export function createSkillLearnTool(fileSystem: FileSystem = defaultFileSystem): ReturnType<typeof tool> {
    const args = {
        ...
        content: tool.schema.string().describe("Summary of what was learned in Caveman English. Do NOT wrap content in XML tags. Include relevant discoveries, source links, examples helping future agents."),
