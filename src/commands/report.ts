...
In above template replace [PLACEHODERS] with following sections:

- Replace [GOAL] with section that has:
    - An H2 heading that summarize overall goal:
...
- Replace [CONSTRAINTS] with section that has:
    - An H2 heading that summarize overall constraints and include subsections which each:
        - Subsection heading summarize 1 key constraint discovery
...
- Replace [CAUSE] with section that has:
    - An H2 heading that summarize cause of problem
...
- Replace [EVIDENCE] with section that has:
    - An H2 heading that summarize what research had proven and include subsections which each:
        - Subsection heading summarize key fact that contributed to research conclusion
...
- Replace [CHANGES] with section that has:
    - An H2 heading that summarize overall change and include subsections which each:
        - Subsection heading summarize 1 key behavioural change
...
- Replace [RESULTS] with section that has:
    - An H2 heading that summarize the outcome
...
- Replace [SHORTCOMING] with section that has:
    - An H2 heading that summarize current shortcoming status of project
    ...
    - For each shortcoming include subsection with:
        - Subsection heading summarizing shortcoming
...
Rules:
- Every heading heading must be < 10 words
