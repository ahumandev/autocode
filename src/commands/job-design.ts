...
2. If no items were listed, reply to user: "No concepts found in \`.agents/jobs/concepts\`. Describe the improvement I should design." and wait for user requirements.
