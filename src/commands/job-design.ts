...
2. If no items were listed, reply to user: "No concepts found in \`.agents/concepts\`. Describe the improvement I should design." and wait for user requirements.
...
5. Continue design workflow in current session using returned concept context and recent conversation.
`
