...
export function createCommands(capabilities: PlatformCapabilities, spyAvailable = false, autoAvailable = true): CommandMap {
    return {
        ...
        "new-design": { description: "Create new 📐 design session to design solution to problem.", subtask: false, template: newSessionTemplate("design", "Summarize steps taken so far", "Design and suggest APPROACHES around discovered OBSTACLES within CONSTRAINTS.") },
