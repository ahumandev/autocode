...
export const newAssistCommandTemplate = newSessionCommandTemplate("assist", `with recent user instructions to solve recently mentioned problem which includes:
